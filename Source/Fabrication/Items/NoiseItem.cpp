...
ANoiseItem::ANoiseItem()
{
	...
	//AI Perception Stimuli Source 컴포넌트 추가 
	StimuliSource = CreateDefaultSubobject<UAIPerceptionStimuliSourceComponent>(TEXT("StimuliSource"));
	//Hearing Sense 등록 (Sight 제외)
...
{
	const FVector NoiseLocation = GetActorLocation(); //소리 발생 위치 = 내 위치 

	const FName NoiseTag = bUseLureTag ? FName("Lure") : NAME_None; //AI Perception에 소리 신호 전송 
	...
	UAISense_Hearing::ReportNoiseEvent( 
		...
		Loudness,
		this,
		0.0f,    //MaxRange(0.0~1.0f) (0.0f = 무제한 | AI HearingRadius에서 처리)
